    ...
    <div class="row">
      ...
      <div class="col-lg-4">
        <div class="card mb-5 mb-lg-0">
          <div class="card-body">
            <h6 class="card-price text-center">Demande d'attestation de travail</h6>
            <form class="form" action="./grh demande/demande_attestravail.html" method="post">
      ...
      <div class="col-lg-4">
        <div class="card mb-5 mb-lg-0">
          <div class="card-body">
           <h6 class="card-price text-center">Demande d'attestation quitter territoire </h6>
            <form class="form" action="./grh demande/quitte.html" method="post">
            	<label for="som">SOM :</label><br/>
            	<input type="number" id="som" name="som" />
            	<button  type="submit" class="btn btn-block btn-primary text-uppercase">Generer</button>
            </form>
